            ...
            <div className="flex w-full items-center gap-1 p-1.5 bg-slate-100/60 dark:bg-slate-800/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 rounded-2xl overflow-x-auto no-scrollbar shadow-inner">
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`
                            flex shrink-0 items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 whitespace-nowrap relative
                            lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-1 lg:px-1.5 lg:text-xs
                            ${activeTab === tab.id
