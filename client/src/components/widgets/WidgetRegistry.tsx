...
const UtmCampaignsWidget = lazy(() => import('./UtmCampaignsWidget').then(m => ({ default: m.UtmCampaignsWidget })));
...
export const WidgetRegistry: Record<string, {
    ...
    'total-sales': { component: TotalSalesWidget, label: 'Total Sales', defaultW: 4, defaultH: 3, requiredPermission: 'view_finance' },
    'recent-orders': { component: RecentOrdersWidget, label: 'Recent Orders', defaultW: 6, defaultH: 5, requiredPermission: 'view_orders' },
    'marketing-roas': { component: AdSpendWidget, label: 'Marketing ROAS', defaultW: 4, defaultH: 3, requiredPermission: 'view_marketing' },
    'live-analytics': { component: LiveAnalyticsWidget, label: 'Live Analytics', defaultW: 4, defaultH: 3 },
    'top-products': { component: TopProductsWidget, label: 'Top Products', defaultW: 6, defaultH: 5, requiredPermission: 'view_finance' },
    ...
    'inventory-risk': { component: InventoryRiskWidget, label: 'Inventory Risk', defaultW: 4, defaultH: 3, requiredPermission: 'view_products' },
    'live-carts': { component: LiveCartsWidget, label: 'Live Carts', defaultW: 4, defaultH: 3, requiredPermission: 'view_orders' },
    'visitor-log': { component: VisitorLogWidget, label: 'Visitor Log', defaultW: 6, defaultH: 5 },
    'ecommerce-log': { component: EcommerceLogWidget, label: 'Ecommerce Stream', defaultW: 6, defaultH: 5, requiredPermission: 'view_orders' },
    'hot-cache': { component: HotCacheWidget, label: 'Hot Cache', defaultW: 4, defaultH: 4 },
    'quick-products': { component: QuickProductsWidget, label: 'Quick Products', defaultW: 6, defaultH: 5, requiredPermission: 'view_products' },
    ...
    'ad-suggestions': { component: AdSuggestionsWidget, label: 'Ad Suggestions', defaultW: 4, defaultH: 4, requiredPermission: 'view_marketing' },
    ...
    'utm-campaigns': { component: UtmCampaignsWidget, label: 'UTM Campaigns', defaultW: 6, defaultH: 5, requiredPermission: 'view_marketing' }
};
