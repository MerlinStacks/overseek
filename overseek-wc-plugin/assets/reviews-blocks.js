	...
	function commonControls( props, options ) {
		...
		return el(
			...
			el(
				...
				options.colors && ColorPalette && el( 'div', { className: 'overseek-review-color-control' }, el( 'p', null, 'Card border colour' ), el( ColorPalette, { colors: colors, value: attributes.color_brdr || '', onChange: function( value ) { props.setAttributes( { color_brdr: value || '' } ); } } ) ),
