...
export const AUSPOST_SERVICE_CATALOG: AusPostServiceCatalogItem[] = [
    ...
    { code: '3D55', label: 'Parcel Post + Signature' },
    { code: '3D61', label: 'Parcel Post + Signature' },
    { code: '3D67', label: 'Parcel Post + Signature' },
    { code: '3D73', label: 'Parcel Post + Signature' },
    { code: '3J55', label: 'Express Post + Signature' },
    { code: '3J61', label: 'Express Post + Signature' },
    { code: '3J67', label: 'Express Post + Signature' },
    { code: '3J73', label: 'Express Post + Signature' },
    { code: '7E55', label: 'Express Post satchel' },
    { code: '7E61', label: 'Express Post satchel' },
    { code: '7E67', label: 'Express Post satchel' },
    { code: '7E73', label: 'Express Post satchel' },
